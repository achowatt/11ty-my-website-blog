...
function pagePosition() {
  if (
    window.scrollY > aboutPos.offsetTop - window.innerHeight / 3 &&
    window.scrollY < projectPos.offsetTop - window.innerHeight / 2
  ) {
    ...
    window.scrollY > projectPos.offsetTop - window.innerHeight / 3 &&
    window.scrollY < contactPos.offsetTop - window.innerHeight / 2
  ) {
    navElements.forEach((element) => element.classList.remove("highlight"));
